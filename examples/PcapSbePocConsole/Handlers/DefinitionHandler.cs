...
namespace PcapSbePocConsole.Handlers
{
    ...
    {
        public static Definition Handle(this SecurityDefinition_4Data message, ReadOnlySpan<byte> variablePart)
        {
        ...
        public static Definition Handle(this SecurityDefinition_12Data message, ReadOnlySpan<byte> variablePart)
        {
            var instrument = new Definition(
                message.SecurityID.Value,
                message.SecurityExchange.ToString(),
